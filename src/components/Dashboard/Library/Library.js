...
LibraryWidget = DragSource(dndTypes.LIBRARY_WIDGET, libraryWidgetSource, libraryWidgetCollect)(
  LibraryWidget
);
...
export default class Library extends Component {
  render() {
    ...
    const custom = this.props.widgetDefinitions.filter(definition => definition.__canvas__ != null);
